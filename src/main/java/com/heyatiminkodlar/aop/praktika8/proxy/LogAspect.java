...
public class LogAspect {
    ...
    /**
     * execution(* com.heyatiminkodlar.aop.praktika8.dao.*.add*(..))
     * The first * represents any return value
     * The second * represents all the classes in the com.heyatiminkodlar.aop.praktika8.dao package
     * The third * means all methods starting with add
     * (..) represents any parameter
     */
    @Before("execution(* com.heyatiminkodlar.aop.praktika8.dao.*.add*(..))|| " +
            "execution(* com.heyatiminkodlar.aop.praktika8.dao.*.delete*(..))||" +
            "execution(* com.heyatiminkodlar.aop.praktika8.dao.*.update*(..))")
    ...
    @After("execution(* com.heyatiminkodlar.aop.praktika8.dao.*.add*(..))|| " +
            "execution(* com.heyatiminkodlar.aop.praktika8.dao.*.delete*(..))||" +
            "execution(* com.heyatiminkodlar.aop.praktika8.dao.*.update*(..))")
     ...
     * @throws Throwable
     */
    @Around("execution(* com.heyatiminkodlar.aop.praktika8.dao.*.add*(..))|| " +
            "execution(* com.heyatiminkodlar.aop.praktika8.dao.*.delete*(..))||" +
            "execution(* com.heyatiminkodlar.aop.praktika8.dao.*.update*(..))")
